            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <Link href="/" className="flex items-center gap-2">
                        <div className="w-8 h-8 bg-teal-600 rounded-lg flex items-center justify-center text-white text-base">🐾</div>
                        <span className="text-lg font-bold text-gray-900 tracking-tight">PawTrust</span>
                    </Link>

                    {/* Desktop Navigation */}
                    <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-gray-600">
                        <Link href="/puppies" className="hover:text-teal-600 transition-colors">Browse Puppies</Link>
                        <Link href="/sell" className="hover:text-teal-600 transition-colors">Sell Your Puppy</Link>
                    ...
                    <div className="hidden md:flex items-center gap-3">
                        <Link
                            href="https://wa.me/918273848985?text=Hello%20PawTrust%2C%20I%20want%20to%20enquire%20about%20a%20puppy."
                            target="_blank"
                ...
                {open && (
                    <div className="md:hidden pb-4 space-y-1 border-t border-gray-100 pt-3">
                        ...
                        <Link
                            ...
                            target="_blank"
                            onClick={() => setOpen(false)}
                            className="flex items-center gap-2 mx-3 mt-2 px-4 py-2 rounded-lg bg-teal-600 text-white text-sm font-semibold justify-center"
                        >
